package com.king.lib.frame_kotlin.view;
...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        mColors = new int[4];
        mColors[0] = Color.parseColor("#C93437");
        mColors[1] = Color.parseColor("#375BF1");
        mColors[2] = Color.parseColor("#F7D23E");
        mColors[3] = Color.parseColor("#34A350");
