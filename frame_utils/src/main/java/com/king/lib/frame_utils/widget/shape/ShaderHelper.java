...
import com.king.lib.frame_utils.R;
...
public abstract class ShaderHelper {
    ...
    public void init(Context context, AttributeSet attrs, int defStyle) {
        if(attrs != null){
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.BaseShaderImageView, defStyle, 0);
            borderColor = typedArray.getColor(R.styleable.BaseShaderImageView_shapeBorderColor, borderColor);
            borderWidth = typedArray.getDimensionPixelSize(R.styleable.BaseShaderImageView_shapeBorderWidth, borderWidth);
            borderAlpha = typedArray.getFloat(R.styleable.BaseShaderImageView_shapeBorderAlpha, borderAlpha);
            square = typedArray.getBoolean(R.styleable.BaseShaderImageView_shapeSquare, square);
            typedArray.recycle();
        }
